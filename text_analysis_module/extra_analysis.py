...
if __name__ == '__main__':
    ...
    n_words = ['' for i in range(max_n_word)] # = 4 ['','','','']
    prev_n_words = ['' for i in range(max_n_word)] # = 4 ['','','','']
    counters = [collections.Counter() for i in range(max_n_word)] # = 4 [Counter, Counter, Counter, Counter]
    ...
    word_stats['lexical_density'] = 100.0 * total_meaningful_words / float(total_words)
