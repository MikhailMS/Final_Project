...
from music_generation_module import run_music_composition, run_tests, music_analysis
...
def run_application():
    ...
    run_music_composition(pcs, sent_score, lex_score, read_score, music_length= 5, epochs=8500)

    # Run final tests to ensure music has been generated correctly
    run_tests(sent_score, read_score) # - FOR TEST PURPOSES
