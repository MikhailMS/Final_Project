...
def shift_key():
    ...
    for fname in music_files:
        ...
        alt_major_names = [f for f in key.alternateInterpretations if ("major" in f.mode)]
        alt_minor_names = [f for f in key.alternateInterpretations if ("minor" in f.mode)]

        if ('major' in key.mode):
            print 'Alternative key: {} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode)
            # Clean with major tonic
            if '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "C major":
                halfSteps = c_tonic[key.tonic.name]
                print 'Minors: {}'.format(halfSteps)

            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "C# major":
                halfSteps = c_s_tonic[key.tonic.name]
                print 'Minors: {}'.format(halfSteps)

            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "D- major":
            ...
            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "E- major":
            ...
            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "F major":
            ...
            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "G major":
                halfSteps = g_tonic[key.tonic.name]
                print 'Minors: {}'.format(halfSteps)

            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "A- major":
            ...
            elif '{} {}'.format(alt_major_names[0].tonic.name, alt_major_names[0].mode) == "B- major":
            ...
            print 'Alternative key: {} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode)
            # Clean with minor tonic
            if '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "C minor":
                halfSteps = c_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)

            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "C# minor":
                halfSteps = c_s_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)

            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "D minor":
                halfSteps = d_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)
            ...
            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "E minor":
                halfSteps = e_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)

            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "F minor":
                halfSteps = f_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)
            ...
            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "G minor":
                halfSteps = g_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)
            ...
            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "A minor":
                halfSteps = a_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)
            ...
            elif '{} {}'.format(alt_minor_names[0].tonic.name, alt_minor_names[0].mode) == "B- minor":
                halfSteps = b_f_tonic[key.tonic.name]
                print 'Majors: {}'.format(halfSteps)
